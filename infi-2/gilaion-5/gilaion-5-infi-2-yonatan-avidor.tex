...
\]
נגזור את הפונקציות $f_n(x) - f(x)$ (תהליך הגזירה זהה לכל $n$)
\begin{gather*}
    \left(f_n(x) - f(x)\right)' \underset{\text{לינאריות הנגזרת}}{=} f_n'\left(x\right) - f'\left(x\right)\\
