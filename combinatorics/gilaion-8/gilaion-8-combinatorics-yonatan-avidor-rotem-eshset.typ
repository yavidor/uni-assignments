...
= פתרון 1
== סעיף א'
הפונקציה $1/(1-x)$ היא הסכום $sum_(n=0)^infinity x^n$ (עבור $|x|<1$ כמובן)\
לכן $1/(1-x)^k$ זה פשוט 
$
(sum_(n=0)^infinity x^n)^k = underbrace((x_1+x_2+dots)(x_1+x_2+dots)+dots+(x_1+x_2+dots),k" פעמים ")
$
נרצה למצוא את המקדם של $x^n$
== סעיף ב'
#pagebreak()
= שאלה 2
