...
$
  f_1 (alpha A_1 + A_2,B) = sum_(i=1)^n sum_(j=1)^n B_(i,j) (alpha A_1 + A_2)_(i,j)=sum_(i=1)^n sum_(j=1)^n B_(i,j) (alpha A_1 + A_2)_(i,j) \
  = sum_(i=1)^n sum_(j=1)^n B_(i,j) (alpha (A_1 + A_2))_(i,j) = sum_(i=1)^n sum_(j=1)^n B_(i,j) alpha((A_1 + A_2))_(i,j) \
  = alpha sum_(i=1)^n sum_(j=1)^n (B_(i,j) A_1_(i,j)) +(B_(i,j) A_2_(i,j))\
  = alpha sum_(i=1)^n sum_(j=1)^n B_(i,j) A_1_(i,j) sum_(i=1)^n sum_(j=1)^n B_(i,j) A_2_(i,j) \
  = alpha f_1(A_1,B) + f_1(A_2,B)
$
=== הרמיטיות
$
...
$
  f_1(A,A) = sum_(i=1)^2 sum_(j=1)^2 A_(i,j) A_(i,j) = sum_(i=1)^2 sum_(j=1)^2 i dot.c i = (i dot.c i) dot.c 4 = -1 dot.c 4 = -4 < 0
$
