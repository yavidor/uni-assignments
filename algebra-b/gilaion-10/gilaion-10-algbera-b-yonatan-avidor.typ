...
מכיוון ש-$T$ אורתוגונלי, כל הערכים העצמיים שלו הם בעלי ערך מוחלט $1$. לכן קיים $lambda in {plus.minus 1}$ ע"ע של $T$, לכן קיים $0_(RR^3) != v_1 in RR^3$ ו"ע נורמלי של $T$ עם ע"ע $lambda$,