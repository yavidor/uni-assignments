...
== סעיף ב'
$T$ אופרטור מעל $RR^3$, 
מכיוון ש-$T$ הוא אופרטור אורתוגונלי, הוא נורמלי, ומכאן יש לו ערך עצמי אחד לפחות.\
מכיוון ש-$T$ אורתוגונלי, כל הערכים העצמיים שלו הם בעלי ערך מוחלט $1$. לכן קיים $lambda in {plus.minus 1}$ ע"ע של $T$, לכן קיים $0_(RR^3) != v_1 in RR^3$ ו"ע נורמלי של $T$ עם ע"ע $lambda$. ניקח את $v_1$ ונשלים אותו לבסיס אורתונורמלי $cal(V)=(v_1,v_2,v_3)$, נתבונן ב-$[T]_(cal(V))$.\
$v_1$ הוא ו"ע של $T$, ולכן העמודה הראשונה של $[T]_(cal(V))$ תהיה $vec(lambda,0,0)$\
מכיוון ש-$T$ בסיס אורתונורמלי,                      